...
*/
  ...
  function(e, t, n) {
    ...
    r.prototype.init = function(e) {
      var t = this;
      return t.config = e,
      "undefined" == typeof document ? void console: ("undefined" == typeof AV ? u.dynamicLoadSource("script", "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js",
      function() {
    ...
    r.prototype._init = function() {
      ...
      try {
        ...
        var z = "-MdYXbMMI" === C.slice( - 9) ? "https://d4iybrb8.api.lncldglobal.com": "https://avoscloud.com";
        AV.init({
          appId: C,
          appKey: L,
          serverURLs: z
        ...
        e.loading = {
          show: function(t) {
            ...
            return t ? U.insertBefore(P, n[0]) : U.appendChild(P),
            e.nodata.hide(),
            e
          },
          hide: function() {
            ...
            return t && u.remove(t),
            0 === u.findAll(U, ".vcard").length && e.nodata.show(),
            e
          }
        };
        ...
        e.alert = {
          show: function(t) {
            ...
            if (n.innerHTML = "" + r + (t && t.type && i), u.on("click", u.find(N, ".vcancel"),
            function(t) {
              e.alert.hide()
          ...
          hide: function() {
            return u.attr(N, "style", "display:none;"),
            e
          }
        },
        e.bind()
    ...
    r.prototype.bind = function(e) {
      ...
      M = function(e) {
        ...
        r = u.find(n, ".vquote");
        return r || (r = u.create("div", "class", "vquote"), n.appendChild(r)),
        r
      },
      C = function e() {
      ...
      j = function(e, t) {
        ...
        function(e) {
          ...
          u.attr(A.comment, "placeholder", n),
          A.comment.focus()
        })
      }; !
      function() {
      ...
      var B = function() {
        ...
        A.comment.value = "",
        w(A.comment),
        u.attr(A.comment, "placeholder", t.placeholder),
        R = {},
        ...
        if (u.attr(I, "disabled")) {
            ...
            ctxt: t.locale.ctrl.ok
				...
				if (v.nick == "" || v.nick == "匿名" || v.nick == "Anonymous") {
					alert('请输入昵称！');
					return void A.nick.focus();
				}
				if (v.mail == "") {
					alert('请输入邮箱！');
					return void A.mail.focus();
				}
				if ("" == v.comment) {
					alert('请输入内容！');
					return void A.comment.focus();
				}
				v.nick = v.nick || "匿名";

				return (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? V(N) : N()))
      },
      U = function() {
        var e = new AV.ACL;
      ...
      clearAttr: function(e) {
        ...
        function(t, r) {
          ...
          case "class":
            ...
            var a = r.value;
            a.indexOf("at") > -1 && p.attr(e, "class", "at"),
            a.indexOf("vemoji") > -1 ? p.attr(e, "class", "vemoji") : p.removeAttr(e, "class");
            break;
          default:
